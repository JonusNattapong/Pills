#!/usr/bin/env node
// Prism config: default mode resolution and config file read/write.
...
const CONFIG_DIR = process.platform === "win32"
  ? path.join(process.env.APPDATA || path.join(require("os").homedir(), "AppData", "Roaming"), "prism")
  : path.join(require("os").homedir(), ".config", "prism");
