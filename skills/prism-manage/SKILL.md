...
name: prism-manage
description: >
  Manage custom Prism pills — create, edit, delete, disable, enable, list.
  Use when the user says "manage pills", "edit pill", "delete pill",
  "disable pill", "update pill", or invokes /prism-manage.
---

# Prism Manage

Manage your custom Prism pills. Full CRUD + disable/enable.
